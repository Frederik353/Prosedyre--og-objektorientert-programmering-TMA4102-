...
class CourseCatalog {
    ...
    public:
        // does not remove duplicates from file but does not add duplicates to map when loading file and the latest course defention is used
        // has added benefit of keeoing track of name changes
        ...
        void saveToFile(std::pair<std::string, std::string> course, std::string filename = "courses.csv");
